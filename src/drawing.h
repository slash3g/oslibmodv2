...
/** See oslSetAlpha2. */
inline void oslSetAlpha(u32 effect, u32 coeff1)			{
...
inline void oslGetAlphaEx(OSL_ALPHA_PARAMS *alpha)		{
...
inline void oslSetAlphaEx(OSL_ALPHA_PARAMS *alpha)		{
...
\endcode */
inline void oslSetImageAutoSwizzle(int enabled)		{
...
inline void oslSetImageFrameSize(OSL_IMAGE *img, u16 width, u16 height)			{
...
inline OSL_PALETTE *oslCreatePalette(int size, short pixelFormat)		{
...
inline void oslUncacheImageData(OSL_IMAGE *img)		{
    if (img != NULL)
...
inline void oslImageIsCopySet(OSL_IMAGE *img, bool enabled)			{
	if (enabled)
...
inline void oslImageIsSwizzledSet(OSL_IMAGE *img, bool enabled)			{
	if (enabled)
...
inline void oslImageSetAutoStrip(OSL_IMAGE *img, bool enabled)			{
	if (enabled)
...
*/
inline void oslSetTextureWrap(int u, int v)		{
...
inline OSL_COLOR oslBlendColor(OSL_COLOR c)		{
